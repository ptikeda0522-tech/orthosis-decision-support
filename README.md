...
- BRS未選択時はKAFO/AFOコース評価を非表示にしました。
- BRS II以下ではKAFOコース評価のみ表示し、AFOコース評価は非表示・無効化します。
- BRS III以上ではAFOコース評価のみ表示し、KAFOコース評価は非表示・無効化します。
- 選択済みのラジオボタンをもう一度押すと、未選択に戻せるようにしました。
